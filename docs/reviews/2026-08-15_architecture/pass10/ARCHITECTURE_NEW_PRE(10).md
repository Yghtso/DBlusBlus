...
4. re-fetch heap page
5. under write latch verify tuple/slot identity and expected header state
6. WAL-log/install slot NORMAL -> DEAD
7. release heap latch
8. register RID retirement with ReadEpochManager
```
