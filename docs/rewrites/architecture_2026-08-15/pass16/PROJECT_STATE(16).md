...
Architecture checkpoint: v1 architecture rewrite reconciled and cut over to `ARCHITECTURE.md`
...
No code change was made during the architecture rewrite. Before normal implementation work resumes on code that depends on the RID codec, reconcile the decoder/tests with `ARCHITECTURE.md` §8.4.1.
